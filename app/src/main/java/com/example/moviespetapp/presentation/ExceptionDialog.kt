...
class ExceptionDialog : DialogFragment() {
    ...
    private var _binding: DialogExceptionBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogExceptionBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun parseParams() {
        ...
        if (!args.containsKey(KEY_MESSAGE))
            throw RuntimeException("Param MESSAGE is absent")
